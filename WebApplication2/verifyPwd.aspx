<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="verifyPwd.aspx.vb" Inherits="WebApplication2.verifyPwd" %>
    ...
    <div style="height:300px">
        ...
        <table class="style1">
            <tr>
                ...
                <td class="style2">
                    <asp:TextBox ID="TextBox1" runat="server" Height="23px" Width="205px"></asp:TextBox>
                </td>
                <td>
                    <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" 
                        ControlToValidate="TextBox1" ErrorMessage="enter e-mail id " ForeColor="Red"></asp:RequiredFieldValidator>
                    <br />
            ...
            <tr>
                <td class="style3">
                    &nbsp;</td>
                <td class="style2">
                    <asp:Button ID="btn" runat="server" Text="Verify" BorderColor="Black" 
